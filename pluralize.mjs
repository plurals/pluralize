 ...
 */
export const addPluralRule = function (rule, replacement) {
 ...
 * @param {string}          replacement
 */
export const addSingularRule = function (rule, replacement) {
 ...
 */
export const addUncountableRule = function (word) {
 ...
 * @param {string} plural
 */
export const addIrregularRule = function (single, plural) {
